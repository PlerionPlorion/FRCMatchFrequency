...
sorted_data = aggregated_data.sort_values(by='Opposing_Count', ascending=False)
...
p = figure(title=title,
           ...
           y_range=(0, max(source.data['Opposing_Count'])*1.1),
...
p.vbar(top='Opposing_Count', x='Team_Key', width=0.5, color=Spectral6[0], source=source,
       legend_label='Matches Against')
